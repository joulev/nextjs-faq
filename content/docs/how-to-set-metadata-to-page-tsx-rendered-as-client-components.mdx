...
messageContent:
  "Move that page file to a separate client component, then import it to the page.tsx that still
  runs as a server component. See [here](<link>) for more info."
---
...
[help me improve this page](https://github.com/joulev/nextjs-discord-common-questions/edit/main/content/docs/how-to-set-metadata-to-page-tsx-rendered-as-client-components.mdx).
